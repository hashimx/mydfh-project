...
sys.path.append(r'C:\Users\hashim1\Downloads\geckodriver-v0.29.1-win64\geckodriver.exe')

# Creating the driver (browser)
driver = webdriver.Firefox(executable_path= r'C:\Users\hashim1\Downloads\geckodriver-v0.29.1-win64\geckodriver')
